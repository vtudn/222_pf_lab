...
// ___________________________________________________ knight2.h ___________________________________________________
// #define DEBUG
...
// ___________________________________________________ knight2.cpp ___________________________________________________
...
// _______________________________________________ main.cpp _______________________________________________
int main(int argc, char **argv)
{
    string file_armyknights, file_events;
    if (argc == 1)
    {
        file_armyknights = "tc/tc1_armyknights";
        file_events = "tc/tc1_events";
    }
    else if (argc == 3)
    {
